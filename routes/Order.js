...
const { add_to_cart, remove_to_cart, update_to_cart, order_generate, place_order, order_update, pending_order, going_order, shipping_order, past_order, past } = require('../Controller/Order_controlle');
